...
- use TDD (Test-Driven Development) by default: write failing tests first, then implement the code to make them pass
- for issue tracking, use GitHub Issues (not Linear) since this is an open-source project
